	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-12">
				<div class="page-title-box d-sm-flex align-items-center justify-content-between">
					<h4 class="mb-sm-0">Lista de horario atencion</h4>
					<div class="page-title-right">
						<ol class="breadcrumb m-0">
							<li class="breadcrumb-item"><a href="javascript: void(0);">Enviar Express</a></li>
							<li class="breadcrumb-item active">Listado de horario atencion</li>
						</ol>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title">Horario atencion</h4>
						<form class="needs-validation" id="form_1">
							...
							<tr>
								<td>A.M</td>
								<td><input class="form-control" type="time" min="01:00" max="12:00" id="lunes_am"></td>
								<td><input class="form-control" type="time" min="01:00" max="12:00" type="text" id="martes_am"></td>
								<td><input class="form-control" type="time" min="01:00" max="12:00" type="text" id="miercoles_am"></td>
								<td><input class="form-control" type="time" min="01:00" max="12:00" type="text" id="jueves_am"></td>
								<td><input class="form-control" type="time" min="01:00" max="12:00" type="text" id="viernes_am"></td>
								<td><input class="form-control" type="time" min="01:00" max="12:00" type="text" id="sabado_am"></td>
								<td><input class="form-control" type="time" min="01:00" max="12:00" type="text" id="domingo_am"></td>
							</tr>
							<tr>
								<td>P.M</td>
								<td><input class="form-control" type="time" min="01:00" max="12:00" type="text" id="lunes_pm"></td>
								<td><input class="form-control" type="time" min="01:00" max="12:00" type="text" id="martes_pm"></td>
								<td><input class="form-control" type="time" min="01:00" max="12:00" type="text" id="miercoles_pm"></td>
								<td><input class="form-control" type="time" min="01:00" max="12:00" type="text" id="jueves_pm"></td>
								<td><input class="form-control" type="time" min="01:00" max="12:00" type="text" id="viernes_pm"></td>
								<td><input class="form-control" type="time" min="01:00" max="12:00" type="text" id="sabado_pm"></td>
								<td><input class="form-control" type="time" min="01:00" max="12:00" type="text" id="domingo_pm"></td>
							</tr>
							</table>
								<br>
