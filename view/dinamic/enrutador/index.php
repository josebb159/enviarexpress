                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-1 overflow-hidden">
                                        <p class="text-truncate font-size-14 mb-2">Comercios</p>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-1 overflow-hidden">
                                        <p class="text-truncate font-size-14 mb-2">Domiciliarios</p>
                                        <h4 class="mb-0" id="domiciliario">0</h4>
                                    </div>
                                    <div class="text-primary ms-auto">
