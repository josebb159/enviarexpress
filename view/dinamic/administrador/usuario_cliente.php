        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Lista de usuarios cliente</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Usuarios cliente</h4>
                                            ...
                                            <div class="row">
                                                              ...
                                                              <div class="col-md-12">
                                                                  ...
                                                                  <input type="hidden" id="img">
                                                                    ...
                                                                    <input type="file" class="form-control" id="image" placeholder="imagen" value="" >
                                                          ...
                                                          <div class="row">
                                                              ...
                                                              <div class="col-md-6">
                                                                  <div class="mb-6">
                                                                      ...
                                                                      <label for="validationCustom01" class="form-label">Teléfono</label>
                                                                      <input type="text" class="form-control" id="telefonoagg"
                                                                          placeholder="Teléfono" value="" required>
                                                              ...
                                                              <div class="col-md-6">
                                                                  <div class="mb-6">
                                                                      <label for="validationCustom02" class="form-label">correo</label>
                                                                      <input type="text" class="form-control" id="correoagg"
                                                                          placeholder="Correo" value="" required>
