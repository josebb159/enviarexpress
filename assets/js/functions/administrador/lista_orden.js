...
function registrar(){
	var result = function_ajax({
		'op':'registrar',
		'id_producto': $("#id_productoagg").val(),
		'cantidad': $("#cantidadagg").val(),
		'valor_uni': $("#valor_uniagg").val(),
		'valor_total': $("#valor_totalagg").val(),
		'estado':'1'
...
function cargar_datos(id_lista_orden,id_producto,cantidad,valor_uni,valor_total){
	$("#id").val(id_lista_orden);
	$("#cantidad").val(cantidad);
	$("#valor_uni").val(valor_uni);
	$("#valor_total").val(valor_total);
	$("#id_producto").val(id_producto);
}

function modificar(){
	var id =  $("#id_lista_orden").val();
