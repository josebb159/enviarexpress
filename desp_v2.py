...
if not os.path.exists(f"controller/{controlador}Controller.php"):
    with open(f"controller/{controlador}Controller.php", 'w') as f:
        ...
        f.write("\t\t\t\t$st = '';\n")
        f.write("\t\t\t}\n")
        f.write("\t\t$key['id']=$key['id_categoria'];\n")
        f.write("\t\t?>\n")
        f.write("\t\t<tr>\n")
...
if not os.path.exists(f"view/dinamic/administrador/{controlador}.php"):
    with open(f"view/dinamic/administrador/{controlador}.php", 'w') as f:
        ...
        f.write('<div class="col-sm-6 col-md-4 col-xl-3">\n')
        f.write('\t<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">\n')
        f.write('\t\t<div class="modal-dialog">\n')
        f.write('\t\t\t<div class="modal-content">\n')
        f.write('\t\t\t\t<div class="modal-header">\n')
        f.write(f'\t\t\t\t\t<h5 class="modal-title mt-0" id="myModalLabel">Modificar {controlador}</h5>\n')
        f.write('\t\t\t\t\t<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>\n')
        f.write('\t\t\t\t</div>\n')
        f.write('\t\t\t\t<form class="needs-validation" id="form_2">\n')
        f.write(f'\t\t\t\t\t<input type="hidden" value="" id="id_{controlador}">\n')
        ...
        for atributo in modelo_atributos:
            ...
            f.write(f'\t\t\t\t\t\t\t\t\t<label for="validationCustom01" class="form-label">{atributo}</label>\n')
            f.write(f'\t\t\t\t\t\t\t\t\t<input type="text" class="form-control" id="{atributo}" placeholder="{atributo}" value="" required>\n')
            f.write('\t\t\t\t\t\t\t\t</div>\n')
            f.write('\t\t\t\t\t\t\t</div>\n')
        ...
        if foraneas[0] != '':
            for forane in foraneas:
                f.write('\t\t\t\t\t\t\t<div class="col-md-6">\n')
                f.write('\t\t\t\t\t\t\t\t<div class="mb-6">\n')
                f.write(f'\t\t\t\t\t\t\t\t\t<label for="validationCustom01" class="form-label">{forane}</label>\n')
                f.write(f'\t\t\t\t\t\t\t\t\t<input type="text" class="form-control" id="id_{forane}" placeholder="{forane}" value="" required>\n')
                f.write('\t\t\t\t\t\t\t\t</div>\n')
                f.write('\t\t\t\t\t\t\t</div>\n')
        ...
        f.write('\t\t\t\t\t\t<button type="button" class="btn btn-light waves-effect" data-bs-dismiss="modal">Cerrar</button>\n')
        f.write('\t\t\t\t\t\t<button type="submit" class="btn btn-primary waves-effect waves-light" >Guardar</button>\n')
        f.write('\t\t\t\t\t</div>\n')
        f.write('\t\t\t\t</form>\n')
        f.write('\t\t\t</div>\n')
        f.write('\t\t</div>\n')
        ...
        f.write('<div class="col-sm-6 col-md-4 col-xl-3">\n')
        f.write('\t<div id="modal_agregar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">\n')
        f.write('\t\t<div class="modal-dialog">\n')
        f.write('\t\t\t<div class="modal-content">\n')
        f.write('\t\t\t\t<div class="modal-header">\n')
        f.write(f'\t\t\t\t\t<h5 class="modal-title mt-0" id="myModalLabel">Agregar {controlador}</h5>\n')
        f.write('\t\t\t\t\t<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>\n')
        f.write('\t\t\t\t</div>\n')
        f.write('\t\t\t\t<form class="needs-validation" id="form_1">\n')
        ...
        for atributo in modelo_atributos:
            ...
            f.write('\t\t\t\t\t\t\t\t<div class="mb-6">\n')
            f.write(f'\t\t\t\t\t\t\t\t\t<label for="validationCustom01" class="form-label">{atributo}</label>\n')
            f.write(f'\t\t\t\t\t\t\t\t\t<input type="text" class="form-control" id="{atributo}agg" placeholder="{atributo}" value="" required>\n')
            f.write('\t\t\t\t\t\t\t\t</div>\n')
            f.write('\t\t\t\t\t\t\t</div>\n')
        ...
        if foraneas[0] != '':
            for forane in foraneas:
                ...
                f.write('\t\t\t\t\t\t\t\t<div class="mb-6">\n')
                f.write(f'\t\t\t\t\t\t\t\t\t<label for="validationCustom01" class="form-label">{forane}</label>\n')
                f.write(f'\t\t\t\t\t\t\t\t\t<input type="text" class="form-control" id="id_{forane}agg" placeholder="{forane}" value="" required>\n')
                f.write('\t\t\t\t\t\t\t\t</div>\n')
                f.write('\t\t\t\t\t\t\t</div>\n')
